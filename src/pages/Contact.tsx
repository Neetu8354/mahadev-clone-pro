...
const Contact = () => {
  const jsonLd = [
    {
      ...
      url: "https://mahadev24x7.live/contact",
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 2, name: "Contact", item: "https://mahadev24x7.live/contact" },
      ],
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO
        title="Contact Mahadev Book — 24x7 WhatsApp Cricket ID Support"
        description="Chat with Mahadev Book on WhatsApp 24x7 in Hindi & English. Get your cricket ID, deposit, withdrawal & support — average reply under 60 sec."
        canonical="/contact"
