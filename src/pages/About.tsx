...
const About = () => {
  const jsonLd = [
    {
      ...
      url: "https://mahadev24x7.live/about",
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 2, name: "About Us", item: "https://mahadev24x7.live/about" },
      ],
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO
        title="About Mahadev Book — Trusted Cricket ID Provider India"
        description="Mahadev Book — India's trusted online cricket & casino ID provider since 2019. 12,000+ verified players, 24x7 Hindi support, instant UPI payout."
        canonical="/about"
