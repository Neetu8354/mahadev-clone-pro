...
const Blog = () => {
  const jsonLd = [
    {
      ...
      url: "https://mahadev24x7.live/blog",
      description: "Expert guides on cricket betting, IPL strategy, live casino, Teen Patti, Andar Bahar and online betting in India.",
      publisher: { "@type": "Organization", name: "Mahadev Book", url: "https://mahadev24x7.live" },
      blogPost: BLOG_POSTS.map(p => ({
        "@type": "BlogPosting",
        headline: p.title,
        url: `https://mahadev24x7.live/blog/${p.slug}`,
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 2, name: "Blog", item: "https://mahadev24x7.live/blog" },
      ],
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO
        title="Cricket Betting & Casino Blog India 2026 | Mahadev Book"
        description="Expert guides on IPL 2026 betting, cricket ID, Teen Patti, Andar Bahar, live casino, UPI deposits & winning strategy from India's top experts."
        canonical="/blog"
