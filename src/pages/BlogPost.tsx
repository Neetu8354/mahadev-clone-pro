...
const BlogPost = () => {
  ...
  const url = `https://mahadev24x7.live/blog/${post.slug}`;
  ...
  const jsonLd: object[] = [
    {
      ...
      author: { "@type": "Organization", name: post.author, url: "https://mahadev24x7.live" },
      publisher: {
        "@type": "Organization",
        name: "Mahadev Book",
        logo: { "@type": "ImageObject", url: "https://mahadev24x7.live/favicon.png" },
      },
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO
        ...
        author={post.author}
        ogImage="https://mahadev24x7.live/og-image.jpg"
        jsonLd={jsonLd}
      />
      <TickerBar />
      <Header />
