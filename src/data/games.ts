...
export const GAMES: GameDef[] = [
  {
    ...
    category: "Sports",
    title: "Online Cricket Betting India 2026 | Mahadev Book",
    h1: "Online Cricket Betting India — IPL 2026, T20 World Cup & Live Odds",
    description: "Play online cricket betting in India on Mahadev Book — IPL 2026, T20 World Cup, BBL, PSL, Tests & ODIs. Match-odds, fancy, session, lambi & toss. UPI.",
