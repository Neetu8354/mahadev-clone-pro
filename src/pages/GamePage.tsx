...
const GamePage = () => {
  ...
  const url = `https://mahadev24x7.live/games/${game.slug}`;
  const jsonLd: object[] = [
    {
      ...
      inLanguage: "en-IN",
      isPartOf: { "@type": "WebSite", name: "Mahadev Book", url: "https://mahadev24x7.live/" },
    },
    {
      "@context": "https://schema.org",
      "@type": "Service",
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 2, name: "Games", item: "https://mahadev24x7.live/games" },
